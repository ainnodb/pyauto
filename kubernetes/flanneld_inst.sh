...
mywget https://github.com/flannel-io/flannel/releases/download/v0.15.1/flannel-v0.15.1-linux-amd64.tar.gz flannel-v0.15.1-linux-amd64.tar.gz

tar -xvf ${DOWNLOADDIR}/flannel-v0.15.1-linux-amd64.tar.gz -C /usr/sbin/
